...
//remember html has a property data-extraproperty
  like= function(element){
    ...
    $.ajax({
            url: "http://localhost:3000/jokes/like/"+joke_id,
            type: "POST",
            data:{ 
              
              "joke_id":joke_id,
              "user_id":user_id //although there is repetition    
                },
            dataType: "json",
            xhrFields: {
            ...
            success:function(data){         
              // row="<tr class='table_row' ></tr><tr class='table_row' ><td>" + data.message.content+"</td></tr>"
  ...
  comment=function(){
    ...
    if(comment_field.value.length<1){  
      ...
      // }
      $.ajax({
            url: "http://localhost:3000/comments/new_comment/",
            type: "POST",
            data:{ 
              "content" : content,
              "joke_id":joke_id,
              "username":username,
              "author_id":author_id //although there is repetition    
                },
            dataType: "json",
            xhrFields: {
                  withCredentials: true
